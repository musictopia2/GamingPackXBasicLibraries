...
namespace BasicGamingUIXFLibrary.BasicControls.MultipleFrameContainers
{
            ...
            where GW : BaseDeckGraphicsXF<CA, GC>, new()
    {
        ...
        public void Unregister()
        {
            ...
            foreach (var pile in _thisGrid!.Children)
            {
                if (pile is PrivateBasicIndividualPileXF<CA, GC, GW> g)
                {
                    g.Dispose();
                }
            }
