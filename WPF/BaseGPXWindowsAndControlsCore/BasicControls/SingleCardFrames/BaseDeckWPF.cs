...
namespace BaseGPXWindowsAndControlsCore.BasicControls.SingleCardFrames
{
            ...
            where GW : BaseDeckGraphicsWPF<CA, GC>, new()
    {
        ...
        public void Init(DeckViewModel<CA> cardModel, string tagUsed)
        {
            DataContext = cardModel;
            _tagUsed = tagUsed;
            _thisMod = cardModel;
            ...
            SetBinding(TextProperty, nameof(DeckViewModel<CA>.TextToAppear));
            SetBinding(IsEnabledProperty, nameof(DeckViewModel<CA>.IsEnabled));
            _thisGrid = new Grid();
            _thisObject = new GW();
