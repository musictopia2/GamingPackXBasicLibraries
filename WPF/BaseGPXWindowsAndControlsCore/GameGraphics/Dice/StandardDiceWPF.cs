...
namespace BaseGPXWindowsAndControlsCore.GameGraphics.Dice
{
    public sealed class StandardDiceWPF : UserControl, ISelectableObject, IRepaintControl
    {
        ...
        public static readonly DependencyProperty CommandProperty = DependencyProperty.Register("Command", typeof(ICommand), typeof(StandardDiceWPF), new FrameworkPropertyMetadata(new PropertyChangedCallback(CommandPropertyChanged)));
        ...
        public static readonly DependencyProperty CommandParameterProperty = DependencyProperty.Register("CommandParameter", typeof(object), typeof(StandardDiceWPF), new FrameworkPropertyMetadata(new PropertyChangedCallback(CommandParameterPropertyChanged)));
