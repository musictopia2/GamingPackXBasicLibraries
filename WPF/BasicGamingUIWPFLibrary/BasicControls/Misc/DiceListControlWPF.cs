...
namespace BasicGamingUIWPFLibrary.BasicControls.Misc
{
    public class DiceListControlWPF<D> : UserControl where D : IStandardDice, new()
    {
        ...
        private void VisibleProcesses()
        {
            ...
            {
                Visibility = Visibility.Hidden; //good news is i can still do this though.
                return;
            }
        ...
        private void DiceBindings(StandardDiceWPF thisGraphics, D thisDice) // needs the dice for the data context
        {
            ...
            VisibleProcesses(); //i think this too.
        }
        ...
        private Binding GetCommandBinding(string path) //hopefully this is still fine here.
        {
