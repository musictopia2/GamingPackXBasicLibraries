...
{
    public class EnumPickerWPF<GC, GW, E> : UserControl
                ...
                where E : struct, Enum
    {
        ...
        private void PopulateList()
        {
            ...
            foreach (var thisPiece in _itemList!)
            {
                ...
                //CheckerPiecesWPF thisGraphics = new CheckerPiecesWPF();
                //TestBindings(thisGraphics, thisPiece);
                PieceBindings(thisGraphics, thisPiece);
                //CustomColor thisGraphics = new CustomColor();
                //thisGraphics.Height = 100;
                //thisGraphics.Width = 100;
                if (Columns == 0 && Rows == 1)
        ...
        {
            MouseUp += EnumPickerWPF_MouseUp;
            //maybe does not have to be proven true anymore since its splitted out now.
            //if i am wrong, rethink.
            //Visibility = Visibility.Collapsed; //has to be proven true
        }

        private void EnumPickerWPF_MouseUp(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
