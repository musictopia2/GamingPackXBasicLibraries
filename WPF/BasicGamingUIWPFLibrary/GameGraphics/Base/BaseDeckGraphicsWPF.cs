...
namespace BasicGamingUIWPFLibrary.GameGraphics.Base
{
        ...
        where CA : IDeckObject where G : class, IDeckGraphicsCP, new()
    {
        ...
        {
            //since its automatic, decided to go ahead and do manually here.
            Binding binding = new Binding(nameof(IDeckObject.Visible));
            binding.Converter = new BooleanToVisibilityConverter();
            //SetBinding(VisibilityProperty, GetVisibleBinding(nameof(IDeckObject.Visible), false));
            SetBinding(VisibilityProperty, binding); //if this does not work because of the collapsed issue, rethink.
