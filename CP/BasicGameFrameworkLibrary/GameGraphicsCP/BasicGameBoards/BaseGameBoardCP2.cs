...
{
    public abstract class BaseGameBoardCP
        //used for games like mexican train dominos where no generics are used.  but mostly the same otherwise.
    {
        ...
        protected abstract Task ClickProcessAsync(SKPoint thisPoint); //try this too.
