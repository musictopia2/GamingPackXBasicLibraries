...
namespace BasicGameFrameworkLibrary.Extensions
{
    public static class SelectEnableDeckExtensions
    {
        ...
        public static DeckObservableDict<D> ToObservableDeckDict<D>(this IEnumerable<D> thisList) where D : IDeckObject
        {
            return new DeckObservableDict<D>(thisList);
        }
        ...
        public static void ReplaceCardPlusRemove<D>(this DeckObservableDict<D> thisList, int oldDeck, int newDeck) where D : IDeckObject
        {
        ...
        public static DeckObservableDict<D> GetNewObjectListFromDeckList<D>(this CustomBasicList<int> thisList,
            IDeckLookUp<D> ThisBase) where D : IDeckObject
        {
            DeckObservableDict<D> output = new DeckObservableDict<D>();
            thisList.ForEach(items =>
            {
