...
namespace BasicGameFrameworkLibrary.DrawableListsObservable
{
    ...
    public class PileObservable<D> : SimpleControlObservable where D : IDeckObject, new()
    {
        ...
        //looks like some solitaire games may require this as well to set visible true/false.
        ...
        public PileObservable(IEventAggregator thisE, CommandContainer command) : base(command) //realy don't want to have to resolve with this library.
        {
