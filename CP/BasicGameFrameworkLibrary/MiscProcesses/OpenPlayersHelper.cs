...
namespace BasicGameFrameworkLibrary.MiscProcesses
{
    public static class OpenPlayersHelper
    {
        ...
        //    get
        //    {
        //        if (_game.SinglePlayerChoice == EnumPlayerChoices.ComputerOnly)
        //            return true;
        //        if (_game.SinglePlayerChoice == EnumPlayerChoices.Either)
        //            return true;
        ...
        //    get
        //    {
        //        if (_game.SinglePlayerChoice == EnumPlayerChoices.HumanOnly)
        //            return true;
        //        if (_game.SinglePlayerChoice == EnumPlayerChoices.Either)
        //            return true;
