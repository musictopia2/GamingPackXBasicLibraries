...
{
    public class BasicMultiplePilesCP<D> : SimpleControlObservable where D : IDeckObject, new()
    {
        ...
        {
            _aggregator.NewCardMessage(EnumNewCardCategories.Basicmultilepilesinglecard); //i think
        }
