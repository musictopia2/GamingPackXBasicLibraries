...
namespace BasicGameFrameworkLibrary.MultiplayerClasses.GameContainers
{
        ...
        where S : BasicSavedCardClass<P, D>, new()
    {
        ...
        //more than one way to get this.  so if something can't use the game class will still work.
        ...
        //some games even require specialized classes to be able to animate play.  one game for example is fluxx card game.
        //Task AnimatePlayAsync(D thisCard)
