...
namespace BaseSolitaireClassesCP.PileViewModels
{
    public class MainPilesCP : IMain
    {
        ...
        public MainPilesCP(IBasicScoreVM thisMod)
        {
            _thisMod = thisMod;
            DeckContents = thisMod.MainContainer!.Resolve<IRegularDeckInfo>(); //this is even better.
            Piles = new BasicMultiplePilesCP<SolitaireCard>(thisMod);
            Piles.Visible = true;
        ...
        {
            _thisMod.Score = score; //try this way.
        }
        ...
        public void FirstLoad(bool needToMatch, bool _showNextNeeded)
        {
            ...
            Piles.Style = BasicMultiplePilesCP<SolitaireCard>.EnumStyleList.HasList;
        ...
        public virtual bool CanAddCard(int pile, SolitaireCard thisCard)
        {
            ...
            if ((int)oldCard.Value + Increments == (int)thisCard.Value)
                return true;
            if (IsRound && Increments == 1 && oldCard.Value == EnumCardValueList.King && thisCard.Value == EnumCardValueList.LowAce)
                return true;
